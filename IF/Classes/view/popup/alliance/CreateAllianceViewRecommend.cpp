...
bool CreateAllianceViewRecommend::onAssignCCBMemberVariable(cocos2d::CCObject *pTarget, const char *pMemberVariableName, cocos2d::CCNode *pNode){
    ...
    //CCB_MEMBERVARIABLEASSIGNER_GLUE_WEAK(this, "m_viewBg", CCScale9Sprite*, this->m_viewBg); //d by ljf
    //CCB_MEMBERVARIABLEASSIGNER_GLUE_WEAK(this, "m_fireNode1", CCNode*, this->m_fireNode1); //d by ljf
    //CCB_MEMBERVARIABLEASSIGNER_GLUE_WEAK(this, "m_fireNode2", CCNode*, this->m_fireNode2); //d by ljf
    ...
    CCB_MEMBERVARIABLEASSIGNER_GLUE_WEAK(this, "m_allianceGood1", CCLabelIF*, this->m_allianceGood1);
    CCB_MEMBERVARIABLEASSIGNER_GLUE_WEAK(this, "m_allianceGood2", CCLabelIF*, this->m_allianceGood2);
    CCB_MEMBERVARIABLEASSIGNER_GLUE_WEAK(this, "m_allianceGood3", CCLabelIF*, this->m_allianceGood3);
    CCB_MEMBERVARIABLEASSIGNER_GLUE_WEAK(this, "m_allianceGood4", CCLabelIF*, this->m_allianceGood4);
...
bool CreateAllianceViewRecommend::init()
{
    if(PopupBaseView::init())
    {
        ...
        CCLoadSprite::doResourceByCommonIndex(7, true); //ljf
        setCleanFunction([](){
        ...
        CCNode* node = CCBLoadFile("AllianceCreateViewRecommend1", this, this);
        ...
        m_allianceIntroEditBox->setPosition(ccp(322.0, 790)); //ljf
        if (CCCommonUtils::isIosAndroidPad())
        {
            //m_allianceIntroEditBox->setPosition(ccp(644, 818 * 2));
            m_allianceIntroEditBox->setPosition(ccp(644, 918 * 2));
...
//        CCCommonUtils::setButtonTitle(m_btnCreate, _lang("115007").c_str());
        ...
        */
        //begin a by ljf
        m_allianceGood1->setString(_lang("500033").c_str());
        m_allianceGood2->setString(_lang("500034").c_str());
        m_allianceGood3->setString(_lang("500036").c_str());
        m_allianceGood4->setString(_lang("500026").c_str());
...
//begin a by ljf
bool CreateAllianceViewRecommend::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent) {
    /*
    if(m_parentType==1) {
        return true;
...
void CreateAllianceViewRecommend::onTouchEnded(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent) {
    /*
    if(m_parentType==1) {
        if (!isTouchInside(m_touchNode, pTouch)) {
            PopupViewController::getInstance()->removeLastPopupView();
...
void CreateAllianceViewRecommend::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent){
