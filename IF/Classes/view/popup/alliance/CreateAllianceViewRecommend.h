...
private:
    ...
    CCSafeObject<CCLabelIF> m_allianceGood1;
    CCSafeObject<CCLabelIF> m_allianceGood2;
    CCSafeObject<CCLabelIF> m_allianceGood3;
    CCSafeObject<CCLabelIF> m_allianceGood4;
    //end a by ljf
