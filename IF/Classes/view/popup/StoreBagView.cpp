...
//        }
    ...
    if(m_a[1]!=-1){
        ...
        if (CCCommonUtils::isIosAndroidPad())
            ...
            CCCommonUtils::createGoodsIcon(m_a[1], m_picNode2, CCSize(110, 110),m_numLabel2);
...
//        }
    ...
    if(m_a[2]!=-1){
        ...
        if (CCCommonUtils::isIosAndroidPad())
            ...
            CCCommonUtils::createGoodsIcon(m_a[2], m_picNode3, CCSize(110, 110),m_numLabel3);
...
//        }
    ...
    if(m_a[3]!=-1){
        ...
        if (CCCommonUtils::isIosAndroidPad())
            ...
            CCCommonUtils::createGoodsIcon(m_a[3], m_picNode4, CCSize(110, 110),m_numLabel4);
