...
#ifndef __IF__DragonBuildBtnsView__
#define __IF__DragonBuildBtnsView__
...
class DragonBuildBtnsView: public CCAniNode
,public CCBMemberVariableAssigner
,public CCBSelectorResolver
{
public:
    DragonBuildBtnsView():m_info(NULL),m_toolInfoId(0),m_buildingKey(0),m_gold(0),buildType(0),m_qid(QID_MAX),lastTime(0),guidKey(""),m_initEnd(false),m_btnNum(2){};
    ~DragonBuildBtnsView(){};
    bool init();
    static DragonBuildBtnsView* create();
...
#endif /* defined(__IF__DragonBuildBtnsView__) */
