...
RecommendAllianceCommand::RecommendAllianceCommand(/*std::string allianceId*/)
: CommandBase(RECOMMEND_ALLIANCE)//,m_allianceId(allianceId)
{
...
{
    if (dict->valueForKey("cmd")->compare(RECOMMEND_ALLIANCE) != 0)
        return false;
