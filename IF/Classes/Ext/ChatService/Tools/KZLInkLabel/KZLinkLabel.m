...
//    }
    //坐标
    if (self.linkDetectionTypes & KZLinkDetectionTypeCoordinate)
    {
        [rangesForLinks addObjectsFromArray:[self getRangesForCoordinate:text.string]];
    }
    //......
...
/** 解析坐标 */
- (NSArray *)getRangesForCoordinate:(NSString *)text
{
    NSMutableArray *rangesForCoordinates = [[NSMutableArray alloc] init];
    NSError *error = nil;
    NSRegularExpression *regex = [[NSRegularExpression alloc] initWithPattern:@"(1200|[1][0-1][0-9]{2}|[1-9][0-9]{2}|[1-9][0-9]|[0-9])([:：])(1200|[1][0-1][0-9]{2}|[1-9][0-9]{2}|[1-9][0-9]|[0-9])"
                                                                      options:0
                                                                        error:&error];
    NSArray *matches = [regex matchesInString:text
                                      options:0
    ...
    for (NSTextCheckingResult *match in matches)
    {
        ...
        [rangesForCoordinates addObject:@{
                                       @"linkType" : @(KZLinkTypeCoordinate),
                                       @"range"    : [NSValue valueWithRange:matchRange],
                                       @"link"     : matchString
                                       }];
    }
    return rangesForCoordinates;
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
