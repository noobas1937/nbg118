...
+(LKDBHelper *)getUsingLKDBHelper
{
    ...
    dispatch_once(&onceToken, ^{
        helper = [[LKDBHelper alloc]initWithCustomNameDB];
    });
    return helper;
}
...
{
    objc_setAssociatedObject(self, &LKModelBase_Key_RowID,[NSNumber numberWithUnsignedInteger:rowid], OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
-(int)rowid
{
...
-(void)modelSetValue:(LKDBProperty *)property value:(id)value
{
    ...
    {
        modelValue =[NSString stringWithFormat:@"%@",value];
    }
