...
-(BOOL) isfromServiceOrLocal_allance{return FALSE;}

-(BOOL) isfromServiceOrLocal_courtries{return FALSE;}
...
-(NSMutableArray*) getUserInfoArray:(int)index{return nil;}
...
-(NSArray*) getChatInfoArray:(int)chatInfoNo :(NSString *)msgTypeStr{return nil;}

-(void) saveInitChatMsg:(NSArray*) chatMessages :(NSString*)chatMessageId{}

-(void) requestActionHistoryMsg:(NSString*) channelId{}

-(NSString *)gettingCustomHeadPic:(NSString *)uid int:(int)picVer{return @"";}
