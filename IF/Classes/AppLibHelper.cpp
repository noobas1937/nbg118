...
void AppLibHelper::sendPayLog(const string &cost,const string &itemId){
    JniMethodInfo minfo;
    if (! JniHelper::getStaticMethodInfo(minfo, "com/clash/of/jni/Jni", "sendPayLog", "(Ljava/lang/String;Ljava/lang/String;)V") ) {
...
void AppLibHelper::sendAdjustTrack(const string &track){
    JniMethodInfo minfo;
    if (! JniHelper::getStaticMethodInfo(minfo, "com/clash/of/jni/Jni", "trackEvent", "(Ljava/lang/String;)V") ) {
