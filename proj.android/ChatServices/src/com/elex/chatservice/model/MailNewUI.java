...
{
//		//Channel ICON
//		public static final String CHANNEL_ICON_BATTLE_REPORT ="mail_list_icon_battle";
//		public static final String CHANNEL_ICON_STUDIO ="mail_list_icon_studio";
//		public static final String CHANNEL_ICON_SYSTEM ="mail_list_icon_system";
//		public static final String CHANNEL_ICON_ALLIANCE ="mail_list_icon_invite";
//		public static final String CHANNEL_ICON_MOD ="mail_list_icon_mod";
//		public static final String CHANNEL_ICON_MESSAGE ="mail_list_icon_chat";
//		public static final String CHANNEL_ICON_ANNOUNCEMENT ="mail_list_icon_announcement";
//		
//		//新邮件UI邮件ICON
//		public static final String MAIL_NEW_ICON_ANNOUNCEMENT ="mail_list_icon_announcement"; 
//		public static final String MAIL_NEW_ICON_BATTLE_EXPLORE ="mail_list_icon_battle_explore";
//		public static final String MAIL_NEW_ICON_BATTLE_CAMP ="mail_list_icon_battle_camp";
//		public static final String MAIL_NEW_ICON_BATTLE_CAPTURE ="mail_list_icon_battle_capture";
//		public static final String MAIL_NEW_ICON_BATTLE_CITY_DEFENT_FAILURE ="mail_list_icon_battle_city_defent_failure";
//		public static final String MAIL_NEW_ICON_BATTLE_CITY_DEFENT_VICTORY ="mail_list_icon_battle_city_defent_victory";
//		public static final String MAIL_NEW_ICON_BATTLE_CITY_FAILURE ="mail_list_icon_battle_city_failure";
//		public static final String MAIL_NEW_ICON_BATTLE_CITY_VICTORY ="mail_list_icon_battle_city_victory";
//		public static final String MAIL_NEW_ICON_BATTLE_DETECT ="mail_list_icon_battle_detect";
//		public static final String MAIL_NEW_ICON_BATTLE_KNIGHT ="mail_list_icon_battle_knight";
//		public static final String MAIL_NEW_ICON_BATTLE_MONSTER ="mail_list_icon_battle_monster";
//		public static final String MAIL_NEW_ICON_BATTLE_REPORT ="mail_list_icon_battle_report";
//		public static final String MAIL_NEW_ICON_INVITE_JOIN_ALLIANCE ="mail_list_icon_invite_join_alliance";
//		public static final String MAIL_NEW_ICON_INVITE_JOIN ="mail_list_icon_invite_join";
//		public static final String MAIL_NEW_ICON_INVITE_KICKEDOUT ="mail_list_icon_invite_kickedout";
//		public static final String MAIL_NEW_ICON_INVITE_MOVE ="mail_list_icon_invite_move";
//		public static final String MAIL_NEW_ICON_INVITE_REJECTED ="mail_list_icon_invite_rejected";
//		public static final String MAIL_NEW_ICON_STUDIO ="mail_list_icon_studio";
//		public static final String MAIL_NEW_ICON_REWARD ="mail_list_icon_reward";
//		public static final String MAIL_NEW_ICON_SEARCH ="mail_list_icon_search";
//		public static final String MAIL_NEW_ICON_ID_BINGING ="mail_list_icon_id_binding";
//		public static final String MAIL_NEW_ICON_SYSTEM_OTHER ="mail_list_icon_system_other";
//		public static final String MAIL_NEW_ICON_SYSTEM_VIP ="mail_list_icon_system_vip";
		...
		private MailNewUI()
		{
			...
			newUIMap.put("CHANNEL_ICON_EVENT","mail_list_main_icon_favorite");
