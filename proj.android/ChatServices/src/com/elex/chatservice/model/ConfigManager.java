...
public class ConfigManager
{
	...
	public String					gameLang				= "zh-CN";	// 用于论坛判定默认显示语言，尚未使用，与游戏进程相关

	public static int				sendInterval			= 1;	// 后台可配置，会被复写
	public static boolean			enableCustomHeadImg		= true;	// 自定义头像开关
	public static int				autoTranlateMode		= 0;
	public static boolean			enableChatHorn			= true;
	public static int				maxHornInputLength		= 140;	// 喇叭消息最大输入长度
