package com.elex.chatservice.widget;
...
public class SimpleSearchView extends LinearLayout
{
  ...
  protected void onFinishInflate()
  {
    ...
    this.searchQuery = ((EditText)findViewById(HSRes.getId(this.mContext, "id", "hs__search_query")));
    this.searchButton = ((ImageButton)findViewById(HSRes.getId(this.mContext, "id", "hs__search_button")));
    this.clearButton = ((ImageButton)findViewById(HSRes.getId(this.mContext, "id", "hs__search_query_clear")));
  ...
  public void setQueryTextListener(SearchViewCompat.OnQueryTextListenerCompat queryTextListener) {
