...
public class GraphRequest {
    ...
    private static final String MY_FRIENDS = "me/invitable_friends";
    private static final String MY_INSTALLED_FRIENDS = "me/friends";
    ...
    private static final String APP_REQUEST_FRIENDS = "me/apprequests";
    ...
    public static GraphRequest newMyFriendsRequest(
        ...
        params.putInt("limit", 200);
        return new GraphRequest(accessToken, MY_FRIENDS, params, null, wrapper);
    }
    
    public static GraphRequest newMyInstallFriendsRequest(
            AccessToken accessToken,
            final GraphJSONArrayCallback callback) {
        Callback wrapper = new Callback() {
            @Override
        ...
        Bundle params = new Bundle();
        params.putInt("limit", 200);
        return new GraphRequest(accessToken, MY_INSTALLED_FRIENDS, params, null, wrapper);
    }

    public static GraphRequest newAppRequestFriendsRequest(
            AccessToken accessToken,
            final GraphJSONArrayCallback callback) {
        Callback wrapper = new Callback() {
            @Override
        ...
        Bundle params = new Bundle();
        params.putString("fields", "from,action_type");
        return new GraphRequest(accessToken, APP_REQUEST_FRIENDS, params, null, wrapper);
    }
